...
data_BT <- read.csv('E:/VIP_Data/shinydemo/shinydemo/shinydemo_BT/data/app_data.csv', header = T) # study level metadata
data_2014 <- read.csv('E:/VIP_Data/shinydemo/shinydemo/shinydemo_BT/data/2014BT.csv', header = T) # metrics from Dornelas et al. 2014
